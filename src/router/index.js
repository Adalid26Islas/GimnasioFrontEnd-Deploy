...
import DashboardMembresiasView from '@/components/MembresiaMiembros/Dashboard.vue'
  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        {
          path: '/dashboard-membresias', name: 'dashboardMembresias', component: DashboardMembresiasView
        },
        {
